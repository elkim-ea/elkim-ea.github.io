...
### 2. VPC 생성하기 ( Set up a VPC (Virtual Private Cloud) )
<img scr="/images/NaverCloud/2025-09-03-190435.png" alt="alt text" width="500">             
1) VPC를 생성해준다. 위의 그림과 같이 10.0.0.0/16로 정해준다.( Create a VPC — set the CIDR block to 10.0.0.0/16, as shown in the diagram above. )     

### 3. Subnet 생성하기 ( Configure a Subnet )
<img scr="/images/NaverCloud/2025-09-03-190558.png" alt="alt text" width="500">        
1) Subnet도 생성해준다. 이 또한 10.0.1.0/24로 정해준다.( Create a Subnet — set the CIDR block to 10.0.1.0/24. )                 

### 4. ACL (방화벽) 생성하기
<img scr="/images/NaverCloud/2025-09-03-191159.png" alt="alt text" width="500">          
<img scr="/images/NaverCloud/2025-09-03-191219.png" alt="alt text" width="500">                    
<img scr="/images/NaverCloud/2025-09-03-191229.png" alt="alt text" width="500">        
...
### 5. ACG( 보안그룹) 생성하기
<img scr="/images/NaverCloud/2025-09-03-191517.png" alt="alt text" width="500">                      
<img scr="/images/NaverCloud/2025-09-03-191534.png" alt="alt text" width="500">              
...
<img scr="/images/NaverCloud/2025-09-03-192058.png" alt="alt text" width="500">                         
<img scr="/images/NaverCloud/2025-09-03-193338.png" alt="alt text" width="500">            
<img scr="/images/NaverCloud/2025-09-03-193706.png" alt="alt text" width="500">                 
<img scr="/images/NaverCloud/2025-09-03-193836.png" alt="alt text" width="500">                       
<img scr="/images/NaverCloud/2025-09-03-194156.png" alt="alt text" width="500">                                  
