...
<img src="{{ '/assets/img/images/aws/LB-SSL-SNI.png' | relative_url }}" alt="스크린샷" width="300">
...
- Time to complete " in-flight requests" while the instance is de-registering
- Stops sending new requests to the EC2 instance which is de-registering
- Between 1 to 3600 seconds (default : 300 seconds)
- Can be disabled (set value to 0) 
- Set to a low value if your requests are short

<img src="{{ '/assets/img/images/aws/Connection Draining.png' | relative_url }}" alt="스크린샷" width="300">

# 10. Auto Scaling Groups (ASG) Overview
...
<img src="{{ '/assets/img/images/aws/AutoScalingGroup.png' | relative_url }}" alt="스크린샷" width="300">

## Auto Scaling Group in AWS with Load Balancer

<img src="{{ '/assets/img/images/aws/AutoScalingGroupinaws.png' | relative_url }}" alt="스크린샷" width="300">
...
<img src="{{ '/assets/img/images/aws/AutoScalingGroupAttributes.png' | relative_url }}" alt="스크린샷" width="300">
...
- Based on the alarm : 
  - We can create scale-out policies ( increase the number oof instance)
  - We can create scale-in policies (decrease the number of instance)

<img src="{{ '/assets/img/images/aws/AutoScalingCloudWatchAlarmsScaling.png' | relative_url }}" alt="스크린샷" width="300"> 

 # 11. Auto Scaling Groups - Scaling Policies
...
<img src="{{ '/assets/img/images/aws/AutoScalingGroup-ScalingPolices.png' | relative_url }}" alt="스크린샷" width="300"> 
...
<img src="{{ '/assets/img/images/aws/Good merics to scale on.png' | relative_url }}" alt="스크린샷" width="300"> 
...
<img src="{{ '/assets/img/images/aws/Cooldown.png' | relative_url }}" alt="스크린샷" width="300"> 
